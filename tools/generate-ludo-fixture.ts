...
//
// The fixture is checked into packages/design-tokens/fixtures/ludo_board_v3.json and is the
...
const fixture = {
    ...
    approachIndices: APPROACH_INDICES,
    ...
    finishSlots: FINISH_SLOTS.map((slots) => slots.map(([x, y]) => ({ x, y }))),
...
const out = resolve(here, '../packages/design-tokens/fixtures/ludo_board_v3.json');
