...
await build({ entryPoints: { app: 'src/main.tsx', engine: 'src/engine.ts' }, outdir: 'dist', bundle: true, format: 'esm', target: ['es2022'], minify: true, sourcemap: false, define: { 'process.env.NODE_ENV': '"production"' } });
