...
enum VoiidColor {
    ...
    static let background   = Color(hex: 0xDFDFDF)   // app base surface
    static let fieldBorder  = Color(hex: 0xE3BED8)
    static let fieldFill    = Color(hex: 0xFCF4F8)
    ...
    static let textPrimary    = Color(hex: 0x4D3E47)
    static let textSecondary  = Color(hex: 0x7A6E74)
